...
public class login extends caseBase {
    ...
    public void getLoginHome(){
        ...
        try{
            new WebDriverWait(driver.supDriver, 20).until(ExpectedConditions.presenceOfElementLocated(By.className("redrain-closeBtn")));
    ...
    public void testLogin(){
        ...
        new WebDriverWait(driver.supDriver, 20).until(ExpectedConditions.presenceOfElementLocated(By.id("signin")));
